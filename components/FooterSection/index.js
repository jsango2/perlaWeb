import { WrapAll, Container, MainLinks, SingleLink, Title, Social, Copy, CopyLink, WrapLogoPerla } from './style.js';
    ...
    <WrapAll>
      ...
      <Container>
        <MainLinks>
          ...
          <Link href='/'>
            <SingleLink>{locale === 'hr' ? 'Proizvodi' : 'Products'}</SingleLink>
          </Link>
        ...
        <Social>
          ...
          <Link href='https://www.instagram.com/perla_bisermora/' target='_blank'>
            <div style={{ cursor: 'pointer' }}>
              <Image src='/Instagram.svg' width={25} height={25} />
            </div>
          </Link>

          <Link href='https://hr.linkedin.com/company/marikomerc' target='_blank'>
            <div style={{ cursor: 'pointer' }}>
        ...
        <Copy>
          <CopyLink>
            Marikomerc d.o.o., Grabi 54, 23241 Poličnik, Hrvatska; info@marikomerc.hr, +385 (0)23/630-539
          </CopyLink>
          <CopyLink>
